...
<meta charset="UTF-8">
    ...
    <title>zPlaque - Déplacement de véhicule</title>
</head>
<body>
    <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="car-inspection-title">
                            <h1 class="h4">Réservez un chauffeur pour amener votre voiture à son<br><span class="h1 car-inspection-h1-title">Déplacement de véhicule</span></h1>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
